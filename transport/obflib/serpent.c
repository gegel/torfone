//**************************************************************************
//ORFone project
//Underlayed symmetric cypher Serpent-128 for transport module
//**************************************************************************
...
#define get_block(x)                            \
    ((unsigned int *)(x))[0] = io_swap(in_blk[3]);     \
    ((unsigned int *)(x))[1] = io_swap(in_blk[2]);     \
    ((unsigned int *)(x))[2] = io_swap(in_blk[1]);     \
    ((unsigned int *)(x))[3] = io_swap(in_blk[0])

#define put_block(x)                            \
    out_blk[3] = io_swap(((unsigned int *)(x))[0]);    \
    out_blk[2] = io_swap(((unsigned int *)(x))[1]);    \
    out_blk[1] = io_swap(((unsigned int *)(x))[2]);    \
    out_blk[0] = io_swap(((unsigned int *)(x))[3])
...
#define get_key(x,len)                          \
    ...
    switch((((len) + 63) / 64)) {               \
    case 2:                                     \
    ((unsigned int *)(x))[0] = io_swap(in_key[3]);     \
    ((unsigned int *)(x))[1] = io_swap(in_key[2]);     \
    ((unsigned int *)(x))[2] = io_swap(in_key[1]);     \
    ((unsigned int *)(x))[3] = io_swap(in_key[0]);     \
    break;                                      \
    case 3:                                     \
    ((unsigned int *)(x))[0] = io_swap(in_key[5]);     \
    ((unsigned int *)(x))[1] = io_swap(in_key[4]);     \
    ((unsigned int *)(x))[2] = io_swap(in_key[3]);     \
    ((unsigned int *)(x))[3] = io_swap(in_key[2]);     \
    ((unsigned int *)(x))[4] = io_swap(in_key[1]);     \
    ((unsigned int *)(x))[5] = io_swap(in_key[0]);     \
    break;                                      \
    case 4:                                     \
    ((unsigned int *)(x))[0] = io_swap(in_key[7]);     \
    ((unsigned int *)(x))[1] = io_swap(in_key[6]);     \
    ((unsigned int *)(x))[2] = io_swap(in_key[5]);     \
    ((unsigned int *)(x))[3] = io_swap(in_key[4]);     \
    ((unsigned int *)(x))[4] = io_swap(in_key[3]);     \
    ((unsigned int *)(x))[5] = io_swap(in_key[2]);     \
    ((unsigned int *)(x))[6] = io_swap(in_key[1]);     \
    ((unsigned int *)(x))[7] = io_swap(in_key[0]);     \
    }

#else

#define get_block(x)                            \
    ((unsigned int *)(x))[0] = io_swap(in_blk[0]);     \
    ((unsigned int *)(x))[1] = io_swap(in_blk[1]);     \
    ((unsigned int *)(x))[2] = io_swap(in_blk[2]);     \
    ((unsigned int *)(x))[3] = io_swap(in_blk[3])

#define put_block(x)                            \
    out_blk[0] = io_swap(((unsigned int *)(x))[0]);    \
    out_blk[1] = io_swap(((unsigned int *)(x))[1]);    \
    out_blk[2] = io_swap(((unsigned int *)(x))[2]);    \
    out_blk[3] = io_swap(((unsigned int *)(x))[3])
...
void Serpent_set_key(unsigned int *l_key,const unsigned int *in_key, const unsigned int key_len)
{
	unsigned int  i,lk,a,b,c,d,e,f,g,h;
    unsigned int  t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16;
...
void Serpent_encrypt(const unsigned int *l_key,const unsigned int *in_blk, unsigned int *out_blk)
{
...
void Serpent_decrypt(const unsigned int *l_key,const unsigned int *in_blk, unsigned int *out_blk)
{
	unsigned int  a,b,c,d,e,f,g,h;
    unsigned int  t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16;
